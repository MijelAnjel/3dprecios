...
// ──────────────────────────────────────────────────────────────
// Mundo 3D — mundo3d.cl — WooCommerce Store API
// Tienda especializada en impresión 3D
// ──────────────────────────────────────────────────────────────

export async function scrapeMundo3d(store: StoreConfig): Promise<ScraperResult[]> {
  ...
  console.log(`[Mundo3D] Total productos: ${results.length}`);
  return results;
}
