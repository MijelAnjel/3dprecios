...
// ──────────────────────────────────────────────────────────────
// MCI Electronics — mcielectronics.cl — WooCommerce Store API
// Tienda de electrónica y componentes con productos de impresión 3D
...
export async function scrapeMciElectronics(store: StoreConfig): Promise<ScraperResult[]> {
  ...
  console.log(`[MCI Electronics] Total productos 3D: ${results.length}`);
  return results;
}
