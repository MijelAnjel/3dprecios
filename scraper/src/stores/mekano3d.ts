...
// ──────────────────────────────────────────────────────────────
// Mekano 3D — mekano3d.cl — WooCommerce Store API
// Tienda especializada en impresión 3D
// ──────────────────────────────────────────────────────────────

export async function scrapeMekano3d(store: StoreConfig): Promise<ScraperResult[]> {
  ...
  console.log(`[Mekano3D] Total productos: ${results.length}`);
  return results;
}
