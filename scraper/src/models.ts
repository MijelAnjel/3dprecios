...
export const STORES: StoreConfig[] = [
  ...
  { id: 'triangulab',       name: 'Triangulab',           slug: 'triangulab',       baseUrl: 'https://triangulab.cl',           logo: 'https://triangulab.cl/favicon.ico',           isActive: false },  // dominio caído
  { id: 'printalot',        name: 'Printalot Chile',      slug: 'printalot',        baseUrl: 'https://printalot.cl',            logo: 'https://printalot.cl/favicon.ico',            isActive: false },  // dominio caído
  { id: '3dinsumos',        name: '3D Insumos',           slug: '3dinsumos',        baseUrl: 'https://3dinsumos.cl',            logo: 'https://3dinsumos.cl/favicon.ico',            isActive: false },  // dominio caído
  { id: 'nebula3d',         name: 'Nébula 3D',            slug: 'nebula3d',         baseUrl: 'https://nebula3d.cl',             logo: 'https://nebula3d.cl/favicon.ico',             isActive: false },  // dominio caído
  { id: 'red3d',            name: 'Red3D',                slug: 'red3d',            baseUrl: 'https://red3d.cl',                logo: 'https://red3d.cl/favicon.ico',                isActive: false },  // dominio caído
  { id: 'mundo3d',          name: 'Mundo 3D',             slug: 'mundo3d',          baseUrl: 'https://mundo3d.cl',              logo: 'https://mundo3d.cl/favicon.ico',              isActive: false },  // dominio caído
  { id: 'mekano3d',         name: 'Mekano 3D',            slug: 'mekano3d',         baseUrl: 'https://mekano3d.cl',             logo: 'https://mekano3d.cl/favicon.ico',             isActive: false },  // dominio caído
  { id: 'open3d',           name: 'Open3D',               slug: 'open3d',           baseUrl: 'https://open3d.cl',               logo: 'https://open3d.cl/favicon.ico',               isActive: false },  // dominio caído
  { id: 'deskfab',          name: 'DeskFab',              slug: 'deskfab',          baseUrl: 'https://deskfab.cl',              logo: 'https://deskfab.cl/favicon.ico',              isActive: false },  // dominio caído
  { id: 'makershop',        name: 'MakerShop',            slug: 'makershop',        baseUrl: 'https://www.makershop.cl',        logo: 'https://www.makershop.cl/favicon.ico',        isActive: false },  // dominio caído
  { id: 'filamentosmaxi',   name: 'Filamentos Maxi',      slug: 'filamentosmaxi',   baseUrl: 'https://filamentosmaxi.cl',       logo: 'https://filamentosmaxi.cl/favicon.ico',       isActive: false },  // dominio caído
  { id: 'bambulab',         name: 'Bambu Lab Chile',      slug: 'bambulab',         baseUrl: 'https://bambulab.com',            logo: 'https://bambulab.com/favicon.ico',            isActive: false },  // sin sección CL verificable
