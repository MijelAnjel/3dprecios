    ...
    specFields: [
      {
        ...
        label: 'Marca',
        type: 'select',
        options: ['Anycubic', 'Creality', 'eSUN', 'Elegoo', 'Graphy', 'Phrozen'],
        filterable: true,
      },
      {
        key: 'type',
    ...
    specFields: [
      {
        ...
        label: 'Marca',
        type: 'select',
        options: ['Anycubic', 'Artillery', 'Bambu Lab', 'Creality', 'eSUN', 'Elegoo', 'Flashforge', 'Prusa', 'TwoTrees'],
        filterable: true,
      },
      {
        key: 'type',
  ...
  },
  {
    ...
    specFields: [
      ...
      },
      {
        ...
        label: 'Capacidad',
        type: 'select',
        options: ['1 bobina', '2 bobinas', '4 bobinas', 'AMS compatible'],
        filterable: true,
      },
    ],
  },
    ...
    specFields: [
      {
        ...
        label: 'Marca',
        type: 'select',
        options: ['Creality', 'Revopoint', 'Shining 3D'],
        filterable: true,
      },
      {
        key: 'series',
        label: 'Serie / Modelo',
        type: 'select',
        options: ['CR-Scan Otter', 'CR-Scan Raptor', 'CR-Scan Ferret', 'Sermoon S1', 'Revopoint RANGE', 'Revopoint MINI'],
        filterable: true,
      },
      {
        key: 'technology',
        label: 'Tecnología',
        type: 'select',
        options: ['Luz estructurada', 'LiDAR', 'Fotogrametría'],
        filterable: true,
      },
    ],
  },
    ...
    specFields: [
      {
        ...
        label: 'Marca',
        type: 'select',
        options: ['Anycubic', 'Atomstack', 'Comgrow', 'Creality', 'Elegoo', 'Ortur', 'Sculpfun', 'TwoTrees', 'xTool'],
        filterable: true,
      },
      {
        key: 'watt',
        ...
        unit: 'W',
        type: 'select',
        options: ['1.6W', '5W', '7W', '10W', '10W Pro', '12W', '20W', '20W Pro', '22W', '22W Pro', '40W', '40W Pro', '60W', '60W Pro'],
        filterable: true,
      },
      {
        key: 'type',
        label: 'Tipo',
        type: 'select',
        options: ['Grabadora diodo', 'CNC Router', 'Combo Grabado + CNC', 'Accesorio láser'],
        filterable: true,
      },
      {
        key: 'workArea',
